#import "templateMarkdown.typ": commonmark

#show: commonmark.with()

= The One-Stop Solution to Low CPU Frequency
_ThrottleStop, the Linux way_

== Why?
When CPU be limited and runs at a low frequency, e.g. 0.4 or 0.8 GHz, it takes tanks of time to fix... ...if your OS is not Windows and can not run #link("https://www.techpowerup.com/download/techpowerup-throttlestop/")[ThrottleStop].
...
== Thanks To:
#link("https://github.com/kitsunyan/intel-undervolt/issues/17")[Antonio Prcela, Roman Makarov] |
#link("https://github.com/DivyanshuVerma/throttlestop-linux")[Divyanshu Verma] |
#link("https://wiki.debian.org/CpuFrequencyScaling")[Debian, Arch Wiki]
