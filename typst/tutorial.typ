...
#show: us_letter.with(
    ...
    footnote: "1 of 1",
    title: [*Typst:* Instant and Incremental Typesetting for Science], 
    authors: ((
        img: "martin.jpg",
        name: "Martin Haug",
        prof: "Full Stack & Operations",
        quote: "Sits down and gets things done.",
        email: "martin.haug@typst.app"),(
        img: "laurenz.jpg",
        name: "Laurenz Mädje",
        prof: "Compiler Developer",
        quote: "Thinks long and comes up with stuff.",
...
All of Typst has been designed with three key goals in mind: Power, simplicity, and performance. We think it's time for a system that matches the power of LaTeX, is easy to learn and use, all while being fast enough to realize instant preview. To achieve these goals, we follow three core design principles:
    ...
    - Performance through Incrementality: All Typst language features must accommodate for incremental compilation. Luckily we have _comemo_, a system for incremental compilation which does most of the hard work in the background.
